...
INSERT INTO MMH_MEMBER VALUES(MMH_MEMBER_SEQ.NEXTVAL, 'dada02', '1234', '다다02', 'xywall@naver.com', '경기도 일산동구 정발산동 1238-3', '3층', 'N', 'A', 'N');
...
--O_P_NO(==M_NO), N_NO, N_TITLE, N_WRITER, N_CONTENT, N_TODAY
"게시판(글작성페이지,공지사항)"
...
--DELETE FROM MMH_NOTE WHERE O_P_NO=1 AND N_NO = 23;
SELECT * FROM MMH_NOTE;

INSERT INTO MMH_NOTE (O_P_NO, N_NO, N_TITLE, N_WRITER, N_CONTENT, N_TODAY)
VALUES((SELECT M_NO FROM MMH_MEMBER WHERE M_NO=1), MMH_NOTE_SEQ.NEXTVAL, '야옹이입니다.', '네코', '야옹야옹야아옹', TO_DATE(SYSDATE, 'YYYY-MM-DD')) 
