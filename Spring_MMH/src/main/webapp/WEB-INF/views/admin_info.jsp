		...
		<div class='section2-wrap'>
			...
			<ul class='section2-box-wrap floatclear'>
				<li>
					<ul>
						...
						<li>
							<h2>
								<i></i> <input type="button" value="공지작성"
			...
			<li>
				<ul>
					...
					<li><form:form method="post" enctype="multipart/form-data"
							modelAttribute="uploadFile" action="upload.do">
									file<br />
							<input type="file" name="mpfile" />
							<br />
							<select name="no">
								<option value="1">1번 사진</option>
								<option value="2">2번 사진</option>
								<option value="3">3번 사진</option>
							</select>
