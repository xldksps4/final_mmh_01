...
<body>
	...
	<div class="container" id='container'
		style="float: left; width: 21cm; height: 29.7cm;">
		<div class="btn_capture">
			<div style="min-width: 100px; clear: none; float: left">
				<span>작성자 : ${dto.nwriter } </span><span> 작성일자 : ${dto.ntoday }</span><br />
				<span>제목 : ${dto.ntitle }</span>
			</div>
			<div style="width: 10px; clear: none; float: left"></div>

			<!-- A4형식 글보기폼 -->
			<div class="book">
				<div class="page">
					<div class="subpage" id="content">${dto.ncontent }</div>
				</div>
				<input type="button" value="삭제" style="float: right;"
					onclick="location.href='ndelete.do?nno=${dto.nno}'" /> <input
					type="button" value="목록"
					onclick="location.href='user_list.do?opno=${dto.opno}&nno=${dto.nno }'" />
			</div>

			<!-- 			</form> -->
			<div style="width: 50px; clear: none; float: left">
	...
	<div class="body-container" style="width: 21cm; min-height:29.7cm; clear: none; float: left">
...
<!-- 			</div> -->
	...
	<script
		src="https://cdnjs.cloudflare.com/ajax/libs/fabric.js/3.6.0/fabric.js"></script>
	<script
		src="https://uicdn.toast.com/tui.code-snippet/v1.5.0/tui-code-snippet.min.js"></script>
	<script
		src="https://uicdn.toast.com/tui-color-picker/v2.2.3/tui-color-picker.min.js"></script>
	<script
	...
	<script
		src="https://uicdn.toast.com/tui-image-editor/latest/tui-image-editor.js"></script>
